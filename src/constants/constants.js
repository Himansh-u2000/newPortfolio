// Portfolio Constants - Edit this file to update your data
...
export const experiences = [
    ...
    },
    {
        ...
        company: "SIESD 2025 – International Conference",
        date: "May 2025",
        desc: "Presented research on 'Predicting the Popularity of Rap and Hip Hop Songs' at SIESD 2025 – International Conference on Smart Innovations Engineering Systems and Designs, Quantum University.",
        skills: [
            "Data Science",
            "Research",
            "Python",
...
export const education = [
    {
        ...
        grade: "CGPA: 7.8",
        desc: "Pursuing B.Tech in Computer Science and Engineering with a minor in Media Management. Courses include Data Structures, Web Technologies, Software Engineering, and App Development. Actively involved in GDG and GDSC technical communities.",
...
export const projects = [
    ...
    },
    {
        ...
        description:
            "End-to-end crop recommendation platform that considers soil data, weather conditions, and market prices using KNN. Features web (React) and mobile (Flutter) interfaces with 95% accurate predictions.",
    ...
    },
    {
        ...
        date: "May 2025",
        description:
            "Fully-featured blogging web app with post creation, login authentication, and a real-time backend using Appwrite. Built with modern React and Redux Toolkit architecture.",
    ...
    },
    {
        ...
        description:
            "AI-based system using Gemini API that predicts personality based on behavioral questions. Features custom dashboard, resume analysis, and real-time scoring logic.",
    ...
    },
    {
        ...
        description:
            "ML model that predicts track popularity using Spotify metadata such as tempo, danceability, etc. Presented at an international research conference.",
